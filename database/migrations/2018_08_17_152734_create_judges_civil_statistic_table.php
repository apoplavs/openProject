...
class CreateJudgesCivilStatisticTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('judges_civil_statistic', function (Blueprint $table) {
            $table->integer('judge')->unique();
            $table->smallInteger('amount')->default(0)->comment('кількість розглянутих цивільних справ');
    ...
    {
        Schema::dropIfExists('judges_civil_statistic');
    }
}
