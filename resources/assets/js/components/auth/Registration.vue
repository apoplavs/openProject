                    ...
                    <form @submit.prevent="validateBeforeSubmit">
                        ...
                        <div class="form-group">
                            ...
                            <p class="control" :class="{error: !(user.repassword === user.password)}">
                                <input id="repassword" type="password" class="form-control" name="repassword" v-model="user.repassword" v-validate="'required|min:6|max:32'" :class="{'is-danger': !(user.repassword === user.password)}">
