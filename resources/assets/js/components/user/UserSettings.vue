          ...
          <div class="row">
            <div class="offset-6 col-6 text-center">
              <button
                ...
                :disabled="errors.has('ім\'я') || errors.has('прізвище') || errors.has('телефон')"
              >Зберегти</button>
            </div>
          </div>
        </form>
          ...
          <div class="row">
            <div class="offset-6 col-6 text-center">
              <button
                type="submit"
                class="btn btn-primary"
                :disabled="isDisabled(errors, password)"
              >Зберегти</button>
            </div>
          </div>
        </form>
          ...
          <div class="table">
            ...
            <div class="row hr">
              ...
              <div class="col-3">
                <input
                  type="checkbox"
                  v-model="notifications.email_notification_1"
                  @click="select()"
                > Email
              </div>
            </div>
            <div class="row bg">
              ...
              <div class="col-3">
                <input
                  type="checkbox"
                  v-model="notifications.email_notification_2"
                  @click="select()"
                > Email
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-3">
                <input
                  type="checkbox"
                  v-model="notifications.email_notification_3"
                  @click="select()"
                > Email
              </div>
            </div>
            <div class="row bg">
              ...
              <div class="col-3">
                <input
                  type="checkbox"
                  v-model="notifications.email_notification_4"
                  @click="select()"
                > Email
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-3">
                <input
                  type="checkbox"
                  v-model="notifications.email_notification_5"
                  @click="select()"
                > Email
              </div>
            </div>
            <div class="row bg">
              ...
              <div class="col-3">
                <input
                  type="checkbox"
                  v-model="notifications.email_notification_6"
                  @click="select()"
                > Email
              </div>
            </div>
  ...
  methods: {
    ...
    changeProfileData() {
      ...
      axios
        ...
        .then(() => {
          this.$toasted.success("Дані успішно збережено!", {
            theme: "primary",
            position: "top-right",
            duration: 8000
          });
    ...
    changePassword() {
      ...
      axios
        ...
        .then(() => {
          this.$toasted.success("Пароль успішно змінено!", {
            theme: "primary",
            position: "top-right",
            duration: 8000
          });
