<template>
    <div>
        <div class="card-body">
            <div v-if="!this.courtsList || this.courtsList.length == 0">За заданими параметрами нічого не знайдено</div>
                ...
                <div class="court-component row mb-3" v-for="(court, ind_1) of this.courtsList" :key="ind_1">
                    ...
                    <div class="col-10 court-component_right py-3">
                        ...
                        <div class="part-2 mt-3">
                            <div><span>Регіон: </span>{{court.region ? court.region : 'невідомо'}}</div>
                            <div><span>Адреса: </span>{{court.address ? court.address : 'невідомо'}}</div>
                        </div>
                        <div class="part-3 mt-3">
                            ...
                            <div class="bookmark">
                                <span v-if="court.is_bookmark" @click="changeBookmarkStatus(court)"><i class="fa fa-bookmark" aria-hidden="true"></i></span>
                                <span v-if="!court.is_bookmark" @click="changeBookmarkStatus(court)"><i class="fa fa-bookmark-o" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
