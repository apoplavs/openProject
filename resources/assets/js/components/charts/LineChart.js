   ...
   data() {
      return {
         datacollection: {
            ...
            labels: ['Цивільне своєчасність розгляду справ', 'Цивільне рішень вистоюють', 'Кримінальне своєчасність', 'Кримінальне рішень вистоюють у вищих інстанціях', 'КУпАП своєчасність', 'КУпАП рішень вистоюють'],
            datasets: [
               {
                  label: 'Data One',
