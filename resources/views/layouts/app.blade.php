...
<head>
	...
	<!-- Styles -->
	<!-- <link href="{{ secure_asset('css/plugins/bootstrap.min.css') }}" rel="stylesheet"> -->
	<link href="{{ secure_asset('css/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
	<link href="{{ secure_asset('css/style.css') }}" rel="stylesheet">
	<!-- <script src="{{ secure_asset('js/plugins/jquery-3.3.1.min.js') }}"></script> -->
