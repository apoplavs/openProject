 ...
 *          description="Ми використовуємо протокол OAuth 2.0 для автентифікації та авторизації користувачів. Кожен запит на любий маршрут (крім /signup i /login) повинен містити токен авторизації, який одночасно є ідентифікатором користувача. Його потрібно передавати в Headers при здійснені запиту. Він повинен виглядати наступним чином:
