...
class JudgesController extends Controller
{
	 ...
	 *     description="Отримати список суддів за заданими параметрами можна передавши параметри (фільтри) пошуку описані нижче. Всі параметри можна використовувати як окремо, так і суміщати декілька параметрів одночасно. Всі результати пошуку відображаються по 10 шт. на одній сторінці",
	 *     operationId="judges",
